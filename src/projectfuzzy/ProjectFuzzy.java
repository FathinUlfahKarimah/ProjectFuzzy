...
public class ProjectFuzzy {
    ...
    public static void main(String[] args){
        ...
        String suhu = JOptionPane.showInputDialog("input suhu");
        int suhu1= Integer.parseInt(suhu);
        
        String kebisingan = JOptionPane.showInputDialog("input suhu");
        int kebisingan1= Integer.parseInt(kebisingan);
        
        String pencahayaan = JOptionPane.showInputDialog("input suhu");
        int pencahayaan1= Integer.parseInt(pencahayaan);
        
        projectfuzzy.kondisi_suhu = suhu1;
        //System.out.println("Suhu:" + projectfuzzy.kondisi_suhu);
        projectfuzzy.kondisi_kebisingan = kebisingan1;
        //System.out.println("Kebisingan:" + projectfuzzy.kondisi_kebisingan);
        projectfuzzy.kondisi_pencahayaan = pencahayaan1;
